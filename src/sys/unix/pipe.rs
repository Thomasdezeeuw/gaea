...
/// poller.register(&mut receiver, CHANNEL_RECV_ID, Ready::READABLE, PollOption::Level)?;
/// poller.register(&mut sender, CHANNEL_SEND_ID, Ready::WRITABLE, PollOption::Level)?;
///
/// loop {
